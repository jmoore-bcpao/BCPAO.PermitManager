...
namespace BCPAO.PermitManager.Data.Migrations
{
    ...
    [Migration("20180118200255_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BCPAO.PermitManager.Data.Entities.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("BCPAO.PermitManager.Data.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("BCPAO.PermitManager.Data.Entities.UserPermission", b =>
                {
                    b.Property<int>("UserId");
            ...
            modelBuilder.Entity("BCPAO.PermitManager.Data.Entities.RolePermission", b =>
                {
                    ...
                    b.HasOne("BCPAO.PermitManager.Data.Entities.Role", "Role")
                        .WithMany("RolePermissions")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("BCPAO.PermitManager.Data.Entities.Role")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("BCPAO.PermitManager.Data.Entities.User")
                        .WithMany("Claims")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
